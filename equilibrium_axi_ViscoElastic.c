...
# changelog Aug 23, 2024 v2.0
This code is in axi. The log-conform-elastic.h is already compatible with axi. 

# changelog Sep 22, 2024 v3.0
This code supports very large Ec. This is done by renormalizing the equations such that the elastic modulus is always 1. 

# changelog Sep 22, 2024 v2.1
Here, we oblitrate v3.0 and then add viscoelasticity. Hopefully, with large enough De, the system would mimic purely elastic behavior. 
